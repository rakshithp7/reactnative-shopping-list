  ...
  return (
    <>
      ...
      <Animated.FlatList
        ...
        renderItem={({ item: productId }) => <ShoppingListProductItem listId={listId} productId={productId} />}
        ...
        ListHeaderComponent={() =>
          description ? (
            <ThemedText style={{ paddingHorizontal: 16, fontSize: 14, color: 'gray' }}>{description}</ThemedText>
          ) : null
        }
        ListEmptyComponent={() => (
          <BodyScrollView
