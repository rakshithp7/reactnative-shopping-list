    ...
    <BodyScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.qrSection}>
        ...
        <View style={styles.qrContainer}>
          <QRCode size={220} value={`groceries-shopping-list://list/new?listId=${listId}`} />
        </View>
      </View>
      ...
      <ThemedText style={styles.disclaimer}>
        ⚠️ Only share your list with people you trust. Anyone with the code can join and edit your list.
      </ThemedText>
    </BodyScrollView>
  );
}
