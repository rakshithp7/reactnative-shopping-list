    ...
    <>
      ...
      <BodyScrollView contentContainerStyle={styles.scrollViewContent}>
        <View style={styles.inputContainer}>
          ...
          />
          <Pressable onPressIn={handleEmojiPress} style={[styles.emojiButton, { borderColor: color }]}>
            <View style={styles.emojiContainer}>
              <Text>{emoji}</Text>
            </View>
          </Pressable>
          <Pressable onPressIn={handleColorPress} style={[styles.colorButton, { borderColor: color }]}>
